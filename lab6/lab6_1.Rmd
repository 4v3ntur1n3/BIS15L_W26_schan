...
ggplot(mapping=aes(x=body_mass_g, y=flipper_length_mm))+
  ...
  labs(title="Body Mass vs. Flipper Length Across Species of Penguins", x="Body Mass (g)", y="Flipper Length (mm)")
```
...
mammals %>% 
  ...
  geom_point()+
  geom_smooth(method="lm", se=T)+
  labs(title="Gestation vs. Newborn Mass", x="Gestation (weeks?)", y="Newborn Mass (log10(g))")
```
